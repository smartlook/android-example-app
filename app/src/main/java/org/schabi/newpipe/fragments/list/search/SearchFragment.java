...
public class SearchFragment extends BaseListFragment<SearchInfo, ListExtractor.InfoItemsPage<?>>
     ...
     */
    private static final int SUGGESTIONS_DEBOUNCE = 500; //ms
    ...
    protected void initViews(final View rootView, final Bundle savedInstanceState) {
        ...
        Smartlook.registerWhitelistedView(searchEditText);
        ...
        suggestionDisposable = observable
                .switchMap(query -> {
                    if (!query.isEmpty()) {
                        ...
                        eventId.set(Smartlook.startTimedCustomEvent("search", bundle));
                    }
                ...
                .subscribe(listNotification -> {
                    if (eventId.get() != null) {
                        Smartlook.stopTimedCustomEvent(eventId.get());
                    }
    ...
    public void handleSuggestions(@NonNull final List<SuggestionItem> suggestions) {
        ...
        Smartlook.trackCustomEvent("search_finished");
